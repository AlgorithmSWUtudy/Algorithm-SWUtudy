...
#             if board[a][b] != 0 and board[a][b] not in permu:
#                 permu.append(board[a][b])
#     for i in itertools.permutations(permu,len(permu)):
#       combi.append(list(i))
#     print(combi)
...
#                 continue
#             print(i, nx,ny)
#             if board[nx][ny] == com[p_num]:
#                 queue.append((nx,ny))
#                 cards.append((nx,ny))
#                 if len(cards) == 2:
#                     p_num= (p_num+1)%len(com)
#                     if board[cards[0][0]][cards[0][1]] == board[cards[1][0]][cards[1][1]]:
#                         board[cards[0][0]][cards[0][1]] = 0
#                         board[cards[1][0]][cards[1][1]] = 0
#                         cards = []
#                     else:
#                         cards = []
